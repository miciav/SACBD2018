...
In Section~\ref{sec:approach} the main design principles that have driven the definition of the overall architecture are presented whereas the architecture, components, and workflow are discussed in Section~\ref{sec:architecture}. %Section~\ref{sec:evaluation} illustrates some preliminary experiments with a large data set.
